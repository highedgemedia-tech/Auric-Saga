...
export const serviceCategories = {
  vastu: {
    ...
    consultationPaths: {
      title: "Find the Vastu service for your exact space.",
      description: "Compare focused Vastu reviews for homes, offices, plots, flats, business locations, remedies, and wealth zones before choosing your consultation."
    },
    subpages: [
  ...
  numerology: {
    ...
    consultationPaths: {
      title: "Choose the numerology reading for your name, date, or decision.",
      description: "Explore personal, business, birth-date, lucky-number, baby-name, mobile-number, and signature-focused numerology sessions."
    },
    subpages: [
  ...
  astrology: {
    ...
    consultationPaths: {
      title: "Select the astrology reading for your timing question.",
      description: "Compare Kundli, career, marriage, compatibility, dasha, transit, muhurat, and birth-time rectification consultations."
    },
    subpages: [
  ...
  "tarot-reading": {
    ...
    consultationPaths: {
      title: "Find the tarot reading that fits your present crossroad.",
      description: "Choose from love, career, yes-or-no, decision-making, monthly, spiritual guidance, third-party energy, and life-path Tarot readings."
    },
    subpages: [
  ...
  "energy-healing": {
    ...
    consultationPaths: {
      title: "Choose the energy healing session for your current state.",
      description: "Review chakra, aura, cord-cutting, emotional release, Reiki, distance, protection, and meditation healing paths."
    },
    subpages: [
